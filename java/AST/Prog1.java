...
public class Prog1 implements Prog{
    ...
    public void generateCode(StringBuilder buffer, String prefix) {
        buffer.append(prefix + "public static void main(String args[]) {\n");
        Inp1.generateCode(buffer, prefix.concat("\t"));
        buffer.append("\n");

        Vars1.generateCode(buffer, prefix.concat("\t"));
        buffer.append("\n");

        Size1.generateCode(buffer, prefix.concat("\t"));
        buffer.append("\n");
